...
When I joined my high school robotics team, something else shifted. Before, I was just a kid doing projects alone in his room. Suddenly I was part of a team, pitching to sponsors, collaborating under real constraints, learning what it actually takes to bring a design from concept to competition. Over four seasons we built competition robots, each one more capable than the last. [[Robot Docs/StretchBot|StretchBot]], [[Robot Docs/MantisBot|MantisBot]], [[Robot Docs/Shreybot|Shreybot]], and [[Robot Docs/BlackBox|BlackBox]] each taught me something the previous one hadn't. The people around me pushed my thinking in ways I hadn't expected. One of my teammates showed me a deal on a [[Project Docs/3d-printing-control|3D printer]]. I bought it immediately, not because I had a specific project in mind, but because I knew getting my hands on one would teach me something. It did. One afternoon I noticed that the handle on my mother's favorite pot had broken. I modeled a replacement and printed it. Watching her reaction to something I had made, something useful, made exactly for her, is a moment I still think about.

## Following the Curiosity

The summer before college, I kept building. An [[Project Docs/hand-tracking-mouse|invisible mouse using hand-tracking]]. An [[Project Docs/auto-tracking-camera|auto-tracking camera powered by computer vision]]. And my proudest project: a drone I built myself, capable of moving in any direction and pulling off flips. I had dreamed about building one for years. Actually doing it, designing it, debugging it, flying it, felt like proof that the path I was on was the right one.

That same energy carried into other projects. I built a [[Project Docs/voice-assistant|local voice assistant]] that ran entirely on my own hardware, a [[Project Docs/satellite-tracking|satellite tracking system]], a [[Project Docs/connect4|Connect 4 AI]] that plays using the minimax algorithm, and a set of [[Project Docs/python-automations|Python automations]] that eliminated repetitive tasks from my daily workflow. I also set up a full [[Project Docs/Home Automation System|home automation system]] connecting smart devices across my house through a Raspberry Pi, and built [[Project Docs/hermes-assistant|Hermes]], an AI assistant that monitors my home server infrastructure and controls IoT devices through natural language.
