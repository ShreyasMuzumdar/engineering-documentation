...
That same energy carried into other projects. I built a local voice assistant that ran entirely on my own hardware, a satellite tracking system, a Connect 4 AI that plays using the minimax algorithm, and a set of Python automations that eliminated repetitive tasks from my daily workflow. I also set up a full home automation system connecting smart devices across my house through a Raspberry Pi, and built an AI assistant that monitors my home server infrastructure and controls IoT devices through natural language.
